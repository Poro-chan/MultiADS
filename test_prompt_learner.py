...
from learn_prompts import MultiADS_PromptLearner
from learn_prompts import mvtech_anomaly_templates
from learn_prompts import visa_anomaly_templates
...
def test(args):
    ...
    prompt_learner = MultiADS_PromptLearner(obj_list, model, templates, details).to(device)
